                        ...
                        <section class="hero">
                            <div class="npTitle">
                                ...
                                <p class="control">
                                    ...
                                    <input class="input-w-4 is-sucess" id="cnpj" name="cnpj" maxlength="18" type="text" onkeypress='cnpjFormat("cnpj")' onblur="cnpjValidadeExisting()" placeholder="CNPJ" required="" value="<?php  if(isset($_POST['cnpj'])) echo htmlspecialchars($_POST['cnpj']); ?>" >
                        ...
                        <section class="hero">
                            <div class="npTitle">
                                ...
                                <p class="control telefone" id="telefoneOrigem">
                                    <input class="input-w-4 is-sucess" id="telefone_0" name="telefone" type="text" maxlength="14" placeholder="(DD) xxxxx-xxxx" onkeypress='telefoneFormat("telefone_0")'  value="<?php  if(isset($_POST['telefone'])) echo htmlspecialchars($_POST['telefone']); ?>" >
                                </p>
                                ...
                                <p class="control">
                                    <input  <?php if(isset($_SESSION['erro-email'])) echo 'class="input-w-6 is-danger"'; else echo 'class="input-w-6 is-sucess"'; ?> id="email" name="email" type="text" maxlength="100" placeholder="Email" required="" value="<?php  if(isset($_POST['email'])) echo htmlspecialchars($_POST['email']); ?>">
