...
<p class="control">
    <input class="input-w-3" id="cep" name="cep" type="text" placeholder="CEP" onkeypress='cepFormat("cep")' onblur="cepValidadeExisting()" required="" maxlength="9" value="<?php  if(isset($_POST['cep'])) echo htmlspecialchars($_POST['cep']); ?>" >
</p>
<div id="cep-erro"></div>
