...
<div class="form-group">
   <label class="col-md-4 control-label" for="CPF">CPF</label>
      <div class="col-md-6">
        ...
        <input id="CNPJ" name="cpf" type="text" placeholder="CPF" class="form-control input-md" required="" value="<?php  if(isset($_POST['cpf'])) echo htmlspecialchars($_POST['cpf']); ?>" >
      </div>
</div>
<!-- Text input-->
<div class="form-group">
   <label class="col-md-4 control-label" for="insc_estadual">RG</label>
      <div class="col-md-6">
        <input id="nome" name="rg" type="text" placeholder="RG" class="form-control input-md" required="" value="<?php  if(isset($_POST['rg'])) echo htmlspecialchars($_POST['rg']); ?>" >
      </div>
</div>
<!-- Text input-->
<div class="form-group">
   <label class="col-md-4 control-label" for="insc_estadual">Data Expedição</label>
      <div class="col-md-2">
        <input id="dataexpedicao" name="dataexpedicao" type="date_format" placeholder="00/00/00" class="form-control input-md" required="" value="<?php  if(isset($_POST['dataexpedicao'])) echo htmlspecialchars($_POST['dataexpedicao']); ?>">
      </div>
</div>
<div class="form-group">
